...
CGame_TanSuo1::CGame_TanSuo1(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_TanSuo1_DLG, pParent)
{
...
void CGame_TanSuo1::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_TANSUO1_ROUND, m_tansuo_round);
	DDX_Control(pDX, IDC_COMBO_TanSuo1_MODE, m_tansuo_mode);
	DDX_Control(pDX, IDC_COMBO_TanSuo1_LAYER, m_tansuo_layer);
	DDX_Control(pDX, IDC_COMBO_TanSuo1_DIFF, m_tansuo_diff);
	DDX_Control(pDX, IDC_COMBO_TanSuo1_MONSTER, m_tansuo_monster);
	DDX_Control(pDX, IDC_CHECK_TanSuo1_RECENT_GROUP, m_tansuo_rencent_group);
	DDX_Control(pDX, IDC_COMBO_TanSuo1_PREFER_FRIEND, m_tansuo_prefer_friend);
	DDX_Control(pDX, IDC_COMBO_TanSuo1_AUTO_BONUS, m_tansuo_auto_bonus);
...
BEGIN_MESSAGE_MAP(CGame_TanSuo1, CDialog)
	ON_BN_CLICKED(IDC_BTN_Tansuo1_ADDTOLIST, &CGame_TanSuo1::OnBnClickedBtnTansuo1Addtolist)
	ON_WM_CTLCOLOR()
END_MESSAGE_MAP()
...
void CGame_TanSuo1::OnBnClickedBtnTansuo1Addtolist()
{
	...
	//次数
	CString round_str;
	GetDlgItemText(IDC_TANSUO1_ROUND, round_str);
	UpdateData(FALSE);
